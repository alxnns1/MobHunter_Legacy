	...
	protected void dropFewItems(boolean hitByPlayer, int lootingLevel)
	{
		...
		else
		{
			for(int n = 0; n < 2 + lootingLevel; n++)
			{
				...
				{
					dropSingleItem(MHItems.itemMiscDrop, MetaRef.getMeta(MetaRef.EnumItemType.MISC_DROP, Names.Items.BRUTE_BONE));
				}
				else
				{
					dropSingleItem(MHItems.itemMiscDrop, MetaRef.getMeta(MetaRef.EnumItemType.MISC_DROP, Names.Items.JUMBO_BONE));
				}
			}
		}
	}
