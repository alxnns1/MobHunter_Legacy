...
public class MHRecipes
{
    public static void init()
    {
        ...
        wcm.addRecipe(MHItems.weaponViperBitePlus, MHItems.weaponViperBite, MetaRef.getStack(MetaRef.EnumItemType.MONSTER_DROP, Names.Items.GENPREY_FANG, 6), MetaRef.getStack(MetaRef.EnumItemType.MONSTER_DROP, Names.Items.MONSTER_BONE_S, 6), MetaRef.getStack(MetaRef.EnumItemType.MONSTER_DROP, Names.Items.PARALYSIS_SAC, 2));
        wcm.addRecipe(MHItems.weaponDeathprize, MHItems.weaponViperBitePlus, MetaRef.getStack(MetaRef.EnumItemType.MONSTER_DROP, Names.Items.GENPREY_FANG, 9), MetaRef.getStack(MetaRef.EnumItemType.MONSTER_DROP, Names.Items.MONSTER_BONE_M, 9), MetaRef.getStack(MetaRef.EnumItemType.MONSTER_DROP, Names.Items.PARALYSIS_SAC, 4));
