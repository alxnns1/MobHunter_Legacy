    ...
    protected List<String> getButtonTooltip(MHCraftingRecipe recipe)
    {
        ...
        for(Object o : recipe.getInput())
        {
            ...
            if(o instanceof ItemStack)
            {
                ...
                list.add(TextFormatting.GRAY +  "" + ((ItemStack) o).stackSize + " x " + colour + ((ItemStack) o).getDisplayName());
            }
            else if(o instanceof List)
            {
                //This basically gets the first ore dictionary string for the item.
                list.add(TextFormatting.GRAY + I18n.format(TOOLTIP + "button.craft.ore") + colour + OreDictionary.getOreName(OreDictionary.getOreIDs(((List<ItemStack>) o).get(0))[0]));
            }
        }
        return list;
    }
