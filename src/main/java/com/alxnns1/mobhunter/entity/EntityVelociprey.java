    ...
    protected void dropFewItems(boolean hitByPlayer, int lootingLevel)
    {
        if(!hitByPlayer) {
            ...
            for(int n=0;n<1+lootingLevel;n++) {
                ...
                if(i<40){
                    dropSingleItem(MHItems.itemMonsterDrop, MetaRef.getMeta(MetaRef.EnumItemType.MONSTER_DROP, Names.Items.VELOCIPREY_FANG));
                }else if(i<69){
                    dropSingleItem(MHItems.itemMonsterDrop, MetaRef.getMeta(MetaRef.EnumItemType.MONSTER_DROP, Names.Items.VELOCIPREY_HIDE));
                }else if(i<92){
