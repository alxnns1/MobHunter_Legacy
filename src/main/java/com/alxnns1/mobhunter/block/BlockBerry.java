...
public class BlockBerry extends BlockNatural
{
    ...
    public ArrayList<ItemStack> getDropsSand(ArrayList<ItemStack> drops, double chance)
    {
        ...
        else if (chance < 0.37936267071320182094081942336874)   drops.add(MetaRef.getStack(MetaRef.EnumItemType.BERRY, "mightSeed"));
        else if (chance < 0.66767830045523520485584218512898)   drops.add(MetaRef.getStack(MetaRef.EnumItemType.BERRY, "nullberry"));
        else if (chance < 0.7814871016691957511380880121396)    drops.add(MetaRef.getStack(MetaRef.EnumItemType.BERRY, "needleberry"));
        else                                                    drops.add(MetaRef.getStack(MetaRef.EnumItemType.BERRY, "bomberry"));
        return drops;
    }

    public ArrayList<ItemStack> getDropsNether(ArrayList<ItemStack> drops, double chance)
    {
        if (chance < 0.069615663524292965917331399564906)       drops.add(MetaRef.getStack(MetaRef.EnumItemType.BERRY, "mightSeed"));
        else if (chance < 0.31109499637418419144307469180568)   drops.add(MetaRef.getStack(MetaRef.EnumItemType.BERRY, "adamantSeed"));
        else if (chance < 0.46337926033357505438723712835391)   drops.add(MetaRef.getStack(MetaRef.EnumItemType.BERRY, "nullberry"));
    ...
    public ArrayList<ItemStack> getDropsCold(ArrayList<ItemStack> drops, double chance)
    {
        ...
        else if (chance < 0.47726912719784571519087597022018)   drops.add(MetaRef.getStack(MetaRef.EnumItemType.BERRY, "mightSeed"));
        else if (chance < 0.68002534452716616505623316964993)   drops.add(MetaRef.getStack(MetaRef.EnumItemType.BERRY, "nullberry"));
        else if (chance < 0.83209250752415650245525106922224)   drops.add(MetaRef.getStack(MetaRef.EnumItemType.BERRY, "needleberry"));
        else                                                    drops.add(MetaRef.getStack(MetaRef.EnumItemType.BERRY, "bomberry"));
        return drops;
    }
    ...
    public ArrayList<ItemStack> getDropsRock(ArrayList<ItemStack> drops, double chance)
    {
        ...
        else if (chance < 0.33986388946174468962672716023923)   drops.add(MetaRef.getStack(MetaRef.EnumItemType.BERRY, "mightSeed"));
        else if (chance < 0.4229738090327902660342338626521)    drops.add(MetaRef.getStack(MetaRef.EnumItemType.BERRY, "adamantSeed"));
        else if (chance < 0.61146628170756857083934831924109)   drops.add(MetaRef.getStack(MetaRef.EnumItemType.BERRY, "nullberry"));
        else if (chance < 0.69808207877912971746751907609818)   drops.add(MetaRef.getStack(MetaRef.EnumItemType.BERRY, "needleberry"));
    ...
    public ArrayList<ItemStack> getDropsOther(ArrayList<ItemStack> drops, double chance)
    {
        ...
        else if (chance < 0.35564693173502456702791232533017)   drops.add(MetaRef.getStack(MetaRef.EnumItemType.BERRY, "mightSeed"));
        else if (chance < 0.49985015855315886678049970380179)   drops.add(MetaRef.getStack(MetaRef.EnumItemType.BERRY, "nullberry"));
        else if (chance < 0.58302958497403909816357110499355)   drops.add(MetaRef.getStack(MetaRef.EnumItemType.BERRY, "scatternut"));
        else if (chance < 0.66881555563299299578353137958671)   drops.add(MetaRef.getStack(MetaRef.EnumItemType.BERRY, "needleberry"));
