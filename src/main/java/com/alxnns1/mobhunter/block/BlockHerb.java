...
public class BlockHerb extends BlockNatural
{
    ...
    {
        if (chance < 0.24044694515556929348449815838642)        drops.add(MetaRef.getStack(MetaRef.EnumItemType.PLANT, "herb"));
        else if (chance < 0.39824025291391164233370007482751)   drops.add(MetaRef.getStack(MetaRef.EnumItemType.PLANT, "fireHerb"));
    ...
    {
        if (chance < 0.15722379603399433427762039660058)        drops.add(MetaRef.getStack(MetaRef.EnumItemType.PLANT, "herb"));
        else if (chance < 0.41643059490084985835694050991504)   drops.add(MetaRef.getStack(MetaRef.EnumItemType.PLANT, "antidoteHerb"));
        else if (chance < 0.58640226628895184135977337110485)   drops.add(MetaRef.getStack(MetaRef.EnumItemType.PLANT, "fireHerb"));
    ...
    {
        if (chance < 0.23785803237858032378580323785803)        drops.add(MetaRef.getStack(MetaRef.EnumItemType.PLANT, "herb"));
    ...
    {
        if (chance < 0.13405341021372206656650559683816)        drops.add(MetaRef.getStack(MetaRef.EnumItemType.PLANT, "herb"));
        else if (chance < 0.31612999282630175552577794020114)   drops.add(MetaRef.getStack(MetaRef.EnumItemType.PLANT, "antidoteHerb"));
        else if (chance < 0.50129261921197601548435998429908)   drops.add(MetaRef.getStack(MetaRef.EnumItemType.PLANT, "fireHerb"));
    ...
    {
        if (chance < 0.15908241598812579991386447291226)        drops.add(MetaRef.getStack(MetaRef.EnumItemType.PLANT, "herb"));
        else if (chance < 0.35843886134033408081858071111877)   drops.add(MetaRef.getStack(MetaRef.EnumItemType.PLANT, "antidoteHerb"));
